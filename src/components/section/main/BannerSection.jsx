  ...
  return (
    <section className='relative w-full mb-0 md:mb-40 mt-16 md:mt-0'>
      ...
      >
        <p
          data-aos='fade-up'
          className='font-bold text-white text-xl  md:text-3xl xl:text-5xl mb-8'
        >
      ...
      {/* 겹쳐지는 카드 섹션 */}
      <div className='hidden absolute -bottom-40 left-1/2 -translate-x-1/2 w-full px-4 xl:block'>
