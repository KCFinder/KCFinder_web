    ...
    <footer className='bg-gray-700 py-12'>
      <div className='container mx-auto'>
        <ul className='flex items-center gap-5 text-white font-semibold'>
          ...
          />
          <li className='mt-2 text-sm md:text-base'>개인정보처리 방침</li>
          <li className='mt-2 text-sm md:text-base'>서비스 이용약관</li>
        </ul>
        <ul className='flex items-center gap-4 text-gray-500 text-sm px-5 md:px-0'>
          <li>
            <p>
              케이씨파인더 ㅣ 대표 : 이현민 ㅣ 대표번호 : 010-3300-4698
              <br />
              부산광역시 부산진구 동천로116 |<br className='md:hidden' />
