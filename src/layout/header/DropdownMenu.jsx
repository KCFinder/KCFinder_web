...
export default function DropdownMenu({
  ...
  return (
    <>
      {activeDropdown && (
        <div
          className='w-full top-[80px] z-[1000] left-0 border-b border-gray-300 flex justify-center items-center flex-wrap text-center bg-white absolute shadow-lg transition-all duration-300 ease-in-out'
          onMouseEnter={() => setActiveDropdown(activeDropdown)}
          onMouseLeave={() => setActiveDropdown(null)}
        >
          <div className='w-full max-w-[1200px] mx-auto'>
            <div className='grid grid-cols-4 gap-12 items-center p-4 md:p-6'>
              <div></div>
